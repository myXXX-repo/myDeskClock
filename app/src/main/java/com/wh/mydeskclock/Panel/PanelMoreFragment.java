...
public class PanelMoreFragment extends Fragment {
    ...
    private View addCheckBox(Context context, String TITLE, String KEY) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_checkbox_fragment_panel_more, null);
        TextView textView = view.findViewById(R.id.tv_item_checkbox_fragment_panel_more);
        textView.setText(TITLE);

        CheckBox checkBox = view.findViewById(R.id.cb_item_checkbox_fragment_panel_more);
